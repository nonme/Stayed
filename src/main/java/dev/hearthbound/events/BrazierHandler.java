...
/**
 * Intercepts F-key interaction on the Brazier and opens the house management UI.
 */
public class BrazierHandler extends EntityEventSystem<EntityStore, UseBlockEvent.Pre> {

    public BrazierHandler() {
