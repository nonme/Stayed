...
/**
 * Intercepts F-key interaction on the Sawmill anchor and opens the Sawmill management UI.
 */
public class SawmillHandler extends EntityEventSystem<EntityStore, UseBlockEvent.Pre> {
    ...
    public void handle(int entityIndex, ArchetypeChunk<EntityStore> chunk,
        ...
        if (!BuildingType.SAWMILL_BLOCK.equals(blockType.getId())) return;
